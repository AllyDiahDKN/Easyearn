...
$sql = "SELECT * FROM deleted_user ORDER BY user_id DESC"; 
$result = $conn->query($sql);
        ...
        echo '<td>
                    <div class="btn-group mb-1">
                        ...
                        <div class="dropdown-menu">
							<a class="dropdown-item" href="restore_user.php?user_id='.$row['user_id'].'" name="Delete" id="userDelete">Restore</a>
                        </div>
                    </div>
                </td>';
        echo "</tr>";
