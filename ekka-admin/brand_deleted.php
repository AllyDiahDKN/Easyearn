...
$sql = "SELECT * FROM deleted_brands";
...
echo '<td>
		<div class="btn-group mb-1">
			...
			<div class="dropdown-menu">
				<a class="dropdown-item" href="restore_brand.php?brand_id='.$row['brand_id'].'" name="Delete" id="BrandDelete">restore</a>
			</div>
...
?>
    ...
    <div class="modal-footer px-4">
        ...
        <button type="submit" class="btn btn-primary btn-pill" name="save_brand">Save Brand</button>
    </div>
</form>
