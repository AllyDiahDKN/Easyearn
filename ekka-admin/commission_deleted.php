...
<head>
	...
	<title>Deleted Commission</title>
...
$sql = "SELECT * FROM deleted_commission";
        ...
        if ($result_orders && $result_orders->num_rows > 0) {
            ...
            echo '<td>
                    <div class="btn-group mb-1">
                        ...
                        <div>
						<a class="dropdown-item" href="restore_commission.php?commission_id='.$row['commission_id'].'" name="Delete" id="commissionDelete">Restore</a>
                        </div>
                    </div>
                </td>';
            echo "</tr>";
